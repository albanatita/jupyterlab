...
class Context implements IDocumentContext < IDocumentModel > {
	 ...
	 */
	kernelChanged : ISignal < Context,
	IKernel > ;

	/**
	 * A signal emitted when the path changes.
	 */
	pathChanged : ISignal < Context,
	string > ;

	/**
	 * A signal emitted when the model is saved or reverted.
	 */
	contentsModelChanged : ISignal < Context,
	IContents.IModel > ;

	/**
	 * A signal emitted when the context is fully populated for the first time.
	 */
	populated : ISignal < IDocumentContext < IDocumentModel > ,
	void > ;
